<template>
  <!-- Main Content -->
  <div class="main main-visible" data-mobile-height="" v-if="status">
    <!-- Chat -->
                ...
                <div class="media text-center text-xl-left">
                  ...
                  <div class="media-body align-self-center text-truncate">
                    ...
                    <small class="text-muted"
                      >HTML, CSS, and Javascript Help</small
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="message-row">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="message-content bg-light">
                      ...
                      <div>
                        Yeah, I'm going to meet a friend of mine at the
              ...
              <div class="message-body">
                ...
                <div class="message-row">
                  <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="dropdown">
                      <a
                        class="text-muted opacity-60 mr-3"
                        href="#"
                        data-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                    ...
                    <div class="message-content bg-primary text-white">
                      <div class="media">
                        ...
                        <div class="media-body overflow-hidden flex-fill">
                          <a
                            href="#"
                            class="d-block text-truncate font-medium text-reset"
                            >bootstrap.min.js</a
                          >
              ...
              <div class="message-body">
                ...
                <div class="message-row">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="message-content bg-light">
                      <div>
                        William is typing<span class="typing-dots"
        ...
        <div class="d-flex h-100 flex-column">
          ...
          <div class="hide-scrollbar flex-fill">
            <div class="border-bottom text-center py-9 px-10">
              ...
              <p class="text-muted">
                Bootstrap is an open source toolkit for developing web with
                HTML, CSS, and JS.
              </p>
            </div>
            ...
            <!-- Navs -->
            <ul
              class="nav nav-tabs nav-justified bg-light rounded-0"
              role="tablist"
            >
              <li class="nav-item">
                <a
                  href="#chat-id-1-members"
            ...
            <div class="tab-content">
              ...
              <div id="chat-id-1-members" class="tab-pane fade show active">
                <ul
                  class="list-group list-group-flush list-group-no-border-first"
                >
                  <!-- Member -->
                      ...
                      <div class="align-self-center ml-5">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            >
                              Promote
                              <span class="ml-auto fe-trending-up"></span>
                            </a>
                            <a
                              class="dropdown-item d-flex align-items-center"
                              href="#"
                            >
                              Restrict
                              <span class="ml-auto fe-trending-down"></span>
                            </a>
                            <a
                              class="dropdown-item d-flex align-items-center"
                              href="#"
                      ...
                      <div class="media-body align-self-center overflow-hidden">
                        <h6 class="text-truncate mb-0">
                          <a
                            href="#"
                            class="text-reset"
                            title="E5419783-047D-4B4C-B30E-F24DD8247731.JPG"
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          ...
                          id="id-add-user-chat-1-user-1"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-1"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-2"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-2"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-3"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-3"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-4"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-4"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-5"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-5"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-6"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-6"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-7"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-7"
                        ></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="align-self-center ml-auto">
                      <div class="custom-control custom-checkbox">
                        <input
                          class="custom-control-input"
                          id="id-add-user-chat-1-user-8"
                          type="checkbox"
                        />
                        <label
                          class="custom-control-label"
                          for="id-add-user-chat-1-user-8"
                        ></label>
                      </div>
                    </div>
                  </div>
          ...
          <div class="hide-scrollbar flex-fill">
            <div class="border-bottom text-center py-9 px-10">
              ...
              <div class="avatar avatar-xl mx-5 mb-5">
                ...
                />
                <div
                  class="badge badge-sm badge-pill badge-primary badge-border-basic badge-top-right"
                >
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item py-6">
                <a href="#" class="media text-muted">
                  <div class="media-body align-self-center">Twitter</div>
              ...
              <li class="list-group-item py-6">
                <a href="#" class="media text-muted">
                  <div class="media-body align-self-center">Facebook</div>
              ...
              <li class="list-group-item py-6">
                <a href="#" class="media text-muted">
                  <div class="media-body align-self-center">Github</div>
